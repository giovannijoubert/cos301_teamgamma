        ...
        {	//try make folder if it doesnt exist --for a pack
            ...
            {   
                ...
                foreach ($data["mouthImages"] as $datas)
                {
                    ...
                    $imagePath="https://teamgamma.ga/mouthpacks/".$data["title"]."/".$filename_path;

                    $sql1 = "INSERT INTO MouthImage(image_id,mouthpack_id,image_URL) VALUES ('{$imageid}','{$packid}','{$imagePath}')";
